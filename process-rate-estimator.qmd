...
$$\frac{\Delta[\ce{N2O}]}{\Delta t} = F_{top} + F_{bottom}  + \ce{N2O}_{\text{nitrification}} + \ce{N2O}_{\text{denitrification}} + \ce{N2O}_{\text{reduction}}$${#eq-state}

$$\frac{\Delta \text{SP}}{\Delta t} = F_{t,i}(\text{SP}_{t,i} - \eta_{SP,dif} - \text{SP}_0) + F_{b,i}(\text{SP}_{b,i}) ...$$
