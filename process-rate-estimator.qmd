...
|$D_{\text{fw}}$| `Dfw`         | Diffusivity of N~2~O in water             |      |                       |[see @eq-Dfw] |
|$D_{\text{fa}}$| `Dfa`         | Diffusivity of N~2~O in air               |      |                       |          |
|$H$            | `H`           | Dimensionless Henry's solubility constant |      |                       |          |
|$\rho$         | `rho`         |                                           |      | $1.26 \times 10^6$    |          |

: Overview of the parameters used in the model. {#tbl-parameters tbl-colwidths="[10,20,30,10,20,10]"}
