...
![Visualization of the optimal hyperparameter size by depth and column for the site N~2~O-N concentration](results/hyperparameters-1.svg){#fig-hyperparameters-1}

![Visualization of the optimal hyperparameter size by depth and column for the site preference.](results/hyperparameters-2.svg){#fig-hyperparameters-2}

![Visualization of the optimal hyperparameter size by depth and column for the $\delta$^18^O concentration.](results/hyperparameters-3.svg){#fig-hyperparameters-3}
