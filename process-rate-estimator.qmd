...
|            | `Dfw`         | Diffusivity of N~2~O in water             |      |                       |
|            | `Dfa`         | Diffusivity of N~2~O in air               |      |                       |
|            | `H`           | Dimensionless Henry's solubility constant |      |                       |
|$\rho$      | `rho`         |                                           |      | $1.26 \times 10^6$    |

: Overview of the parameters used in the model. {#tbl-parameters tbl-colwidths="[10,20,30,20,20]"}
