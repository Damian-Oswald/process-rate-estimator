...
svg(file.path("scripts","sensitivity-analysis","output","covariance-norm.svg"), width = 8, height = 5)
...
text(x = as.numeric(b), y = as.numeric(df)*0.9, labels = 1:12, pos = 3, cex = 0.65, font = 2, col = rep(palette(5),each=12))
