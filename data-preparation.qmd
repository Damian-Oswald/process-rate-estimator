...
![Optimal hyperparameter size by depth and column for the preference.](graphics/hyperparameters-2.svg){#fig-hyperparameters-2 width=100%}

## Stable isotope ratio	($\delta$^18^O)

![Optimal hyperparameter size by depth and column for the $\delta$^18^O concentration.](graphics/hyperparameters-3.svg){#fig-hyperparameters-3 width=100%}
...
### Using kernel regression for function estimation
