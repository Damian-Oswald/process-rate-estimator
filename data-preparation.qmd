...
|             | (`YYYY-MM-DD`)    |                            |             |         |                                              |
+-------------+-------------------+----------------------------+-------------+---------+----------------------------------------------+
| `column`    | Column            | One out of twelve          | `"ordered"` | 0%      |                                              |
|             |                   | experimental units.        |             |         |                                              |
+-------------+-------------------+----------------------------+-------------+---------+----------------------------------------------+
| `depth`     | Measurement depth | Depth of the measurement,  | `"numeric"` | 0%      |                                              |
|             |                   | either 7.5, 30, 60, 90, or |             |         |                                              |
|             |                   | 120 cm.                    |             |         |                                              |
+-------------+-------------------+----------------------------+-------------+---------+----------------------------------------------+
| `increment` | Height of a       |                            | `"integer"` | 0%      |                                              |
|             | specific layer    |                            |             |         |                                              |
+-------------+-------------------+----------------------------+-------------+---------+----------------------------------------------+
| `variety`   | Wheat variety     | Either `CH Claro`,         | `"factor"`  | 0%      |                                              |
|             |                   | `Monte Calme 268`,         |             |         |                                              |
|             |                   | `Probus`, or `Zinal`.      |             |         |                                              |
+-------------+-------------------+----------------------------+-------------+---------+----------------------------------------------+
| `moisture`  | Soil moisture     |                            | `"numeric"` | 0%      | ![](graphics/hist-moisture.png){width=300px} |
+-------------+-------------------+----------------------------+-------------+---------+----------------------------------------------+
| `N2O`       | Corrected         |                            | `"numeric"` | 86.9%   | ![](graphics/hist-N2O.png){width=300px}      |
|             | N~2~O conc.       |                            |             |         |                                              |
+-------------+-------------------+----------------------------+-------------+---------+----------------------------------------------+
| `SP`        | Site preference   | Site preference values     | `"numeric"` | 86.3%   | ![](graphics/hist-SP.png){width=300px}       |
|             |                   | for N~2~O                  |             |         |                                              |
+-------------+-------------------+----------------------------+-------------+---------+----------------------------------------------+
| `d18O`      | Stable isotope    | Ratio of stable isotopes   | `"numeric"` | 86.3%   | ![](graphics/hist-d18O.png){width=300px}     |
|             | ratio             | oxygen-18 (^18^O) and      |             |         |                                              |
|             |                   | oxygen-16 (^16^O).         |             |         |                                              |
+-------------+-------------------+----------------------------+-------------+---------+----------------------------------------------+

: Overview of the variables included in the `measurements` data as included in the R package `PRE`. {#tbl-measurements tbl-colwidths="[9,15,32,8,8,23]"}
