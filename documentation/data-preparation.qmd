...
![Visualization of the optimal hyperparameter size by depth and column for the site N~2~O-N concentration](graphics/hyperparameters-1.svg){#fig-hyperparameters-1 width=100%}

![Visualization of the optimal hyperparameter size by depth and column for the site preference.](graphics/hyperparameters-2.svg){#fig-hyperparameters-2 width=100%}

![Visualization of the optimal hyperparameter size by depth and column for the $\delta$^18^O concentration.](graphics/hyperparameters-3.svg){#fig-hyperparameters-3 width=100%}
