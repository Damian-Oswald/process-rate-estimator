...
Sensitivity analysis is a method used to determine how different values of model parameters impact a particular model output value under a given set of assumptions [@trucano2006calibration].
...
1. [Define parameter distribution](sensitivity-analysis.qmd#sec-prior).
2. [Sample from parameter space](sensitivity-analysis.qmd#sec-sampling).
3. [Calculate model output of interest](sensitivity-analysis.qmd#sec-calculating).
